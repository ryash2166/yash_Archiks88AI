      ...
      <div className="bg-white dark:bg-primary rounded-lg shadow-xl w-full max-w-md mx-4 overflow-hidden">
        <div className="p-6 flex flex-col items-center">
          ...
          <div className="flex gap-4 mt-6 w-full">
            <button
              onClick={onClose}
              className="flex-1 py-3 text-center text-blue-light font-medium bg-transparent border border-blue-light hover:underline rounded-lg"
            >
              Close
            </button>
            <button
              onClick={onConfirm}
              className="flex-1 py-3 text-center text-white font-medium bg-red-500 hover:bg-red-700 transition rounded-lg"
            >
              Delete
            </button>
          </div>
