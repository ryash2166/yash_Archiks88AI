...
//   // Check if the form is valid (either login or signup)
//   const isFormValid =
//     email &&
//     password &&
//     (!isSignUp || (isSignUp && password === confirmPassword));
...
//             {isSignUp ? "Create an account" : "Welcome to Archiks88 AI"}
//           </h1>
//           <p className="mt-2">
...
//               placeholder={isSignUp ? "Enter Email Address" : "Email"}
//             />
//           </div>
//           <div className="mt-4">
...
//             <button className="mx-[6px] cursor-pointer text-inherit hover:text-[#72e528]">Forgot Password</button>
//           </div>
//         </div>
//       </div>
//     </div>
