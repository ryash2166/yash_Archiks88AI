...
const Banner = ({
  ...
  return (
    ...
    >
      ...
      <h2 className="mb-3 relative">
        <span
          className={`bg-[#191d21] text-[22px] sm:text-[24px] md:text-[28px] lg:text-[32px] leading-7 text-transparent bg-clip-text bg-gradient-to-r from-[#5252e5] to-[#6c6cf5] transition-all duration-300 ease-in-out ${
            !isDisabled
              ? "group-hover:bg-gradient-to-l duration-300 ease-linear"
              : ""
          }`}
